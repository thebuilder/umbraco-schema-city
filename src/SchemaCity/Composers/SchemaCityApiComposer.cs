...
{
    public class SchemaCityApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                opt.OperationFilter<SchemaCityOperationSecurityFilter>();
            });
        }

        public class SchemaCityOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("SchemaCity.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
