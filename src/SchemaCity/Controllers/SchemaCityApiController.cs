...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "SchemaCity")]
    public class SchemaCityApiController : SchemaCityApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public SchemaCityApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
